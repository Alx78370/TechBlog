 ...
 *
 * @checksum - c235b265360ac937eae120c4636c2979ce92c862e919b07a8f6ece56627e0400
 * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=zinc,spacing=2,scale=lg,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-cyan-500': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
